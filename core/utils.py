...
MASK32 = 0xFFFF_FFFF          # added — required by LEA, SPARX, and GRAIN

# ── AES primitives (used by Rocca, SNOW-Vi, SKINNY) ─────────────────────────
_AES_SBOX = [
...
def rotr32(x: int, n: int) -> int:     # added — required by LEA round function
    return ((x >> n) | (x << (32 - n))) & MASK32
